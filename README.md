...
4Repeat steps 2 and 3 until convergence, then use the model for prediction.
...
## Output:
<img width="642" height="489" alt="image" src="https://github.com/user-attachments/assets/6ea50ae2-65df-49f6-b961-03a2ac298e18" />
